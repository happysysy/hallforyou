...
<body>
	...
	<div class="content">
		...
		<h4 class="checkform">예약 확인서</h4><hr>
			<ul>
				<li>
				...
				<li>
					<span class="tmenu">이름</span>
					<span class="tcon"><%=vo.getOkmname() %></spna>	
				</li>
				<br>
				<li>
					<span class="tmenu">날짜</span>
					<span class="tcon"><%=vo.getOkwdate() %></spna>	
				</li>
				<br>
				<li>
					<span class="tmenu">시간</span>
					<span class="tcon"><%=vo.getWtime() %></spna>
				</li>
				<br>
				<li>
					<span class="tmenu">HALL TYPE</span>
					<span class="tcon"><%=vo.getOkhtype() %></span>
				</li>
			</ul>
			...
			<a href="http://localhost:9000/hallforyou/admin/list_delete.do?bno=<%=vo.getBno()%>">
				<span class="btn">목록 삭제</span>
			</a>
			<a href="http://localhost:9000/hallforyou/admin/book_delete.do?bno=<%=vo.getBno()%>">
				<span class="btn">예약 삭제</span>
			</a>
