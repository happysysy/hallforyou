...
제24조(재판권 및 준거법)
 ...
 ②“몰”과 이용자간에 제기된 전자상거래 소송에는 한국법을 적용합니다.
		    ...
		    <br>
		    <input type="checkbox" name="agree1" id="agree1">이용약관에 동의합니다.
		    <br><br><br><br>
...
'정보통신망 이용촉진 및 정보보호 등에 관한 법률'의 거래기록 보존 의무에 따른 보존: 1년
			...
			<br>
			<input type="checkbox" name="agree2" id="agree2">개인정보 수집 및 이용에 대한 안내에 동의합니다.
			<br><br><br>
			<a href="http://localhost:9000/hallforyou/user/hfu_join_user.do" target="_top"><span class="joinUser_ok" id="member_join">일반 회원가입</span></a>
			<a href="http://localhost:9000/hallforyou/user/hfu_join_admin.do" target="_top"><span class="joinAdmin_ok" id="admin_join">사업자 회원가입</span></a>
		</div>
	</div>
	<!-- ########## join end ########## -->
