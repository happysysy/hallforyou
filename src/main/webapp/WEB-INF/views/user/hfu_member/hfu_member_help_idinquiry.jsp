...
<body>
	...
	<!-- ########## member_help_idinquiry start ########## -->
	<div class="content" style="height:600px;">
		<h3 class="bottom_bar">아이디 찾기</h3>
		<h4 class="help">
			<p>고객님의 아이디/패스워드를 찾기위해서는 이메일 인증을 거치셔야 합니다.</p>
			<p>아래의 인증 방법을 진행해 주세요.</p>
			<p>인증 완료시, E-mail을 통해 아이디를 알려드리며, 원하실 경우 패스워드를 변경하실 수 있습니다.</p>
		</h4>
		<form name="idinquiry" id="idinquiry" action="idinquiry1" method="post">
			<table class="help">
				<tr>
					<td class="ftd">이름</td>
			...
			<br><br><br><br><br><br>
			<div class="okCancel">
				<span class="joinAdmin_join" id="idinquiry1" name="idinquiry1" style="cursor:pointer">확인</span>
				<a href="http://localhost:9000/hallforyou/user/hfu_help.do"><span class="joinAdmin_cancel" name="" id="">취소</span></a>
			</div>
		</form>
		<br>
	</div>
	<!-- ########## member_help_idinquiry end ########## -->
